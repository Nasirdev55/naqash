<header class="main-header-area">
    <div class="header-top d-none d-lg-block" style="background: #102944;">
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="header-middle-wrap position-relative">
                        <div class="header-contact d-none d-lg-flex">
                            ...
                            <a href="tel://+92-111-000-786">+92-111-000-786</a>
                        </div>

                        <a href="index.html" class="header-logo" style="width:10%;">
                            <img src="{{asset('assets/images/ishoplogo.png')}}" alt="Header Logo">
                        </a>
                        ...
                        <div class="header-right">
                            <ul>
                                ...
                                <li class="dropdown d-none d-lg-block">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="settingButton" style="">
                                        @guest
                                        <li><a class="dropdown-item" href="/site/login">Login | Register</a>
                                        @else
                                        <li><a class="dropdown-item" href="my-account.html">My account</a></li>
                                        <li><a class="dropdown-item" href="my-account.html">{{\Illuminate\Support\Facades\Auth::user()->fname}}</a></li>
                                        <li><a class="dropdown-item" href="{{ route('site-logout') }}" onclick="event.preventDefault();document.getElementById('logout').submit();">Logout</a></li>

                                            <form action="{{ route('site-logout') }}" method="post" class="d-none" id="logout">
                                                @csrf
                                            </form>
                                        @endguest
                                        </li>
                                ...
                                <li class="minicart-wrap me-3 me-lg-0">
                                    <a href="{{route('product.show-carts')}}">
                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="main-menu">
                            <nav class="main-nav">
                                <ul>
                                    <li class="drop-holder">
                                        <a href="http://127.0.0.1:8000/site">Home</a>
                                    ...
                                    <li>
                                        <a href="http://127.0.0.1:8000/site/about-us">About Us</a>
                                    </li>
                                    <li class="drop-holder">
                                        <a href="http://127.0.0.1:8000/site/faq">FAQ</a>
                                    ...
                                    <li>
                                        <a href="http://127.0.0.1:8000/site/contact">Contact Us</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
        ...
        <div class="offcanvas-body">
            <div class="minicart-content">
                <div class="minicart-heading">
                    ...
                    <a href="#" class="button-close"><i class="pe-7s-close" data-tippy="Close" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder" tabindex="0"></i></a>
                </div>
                <ul class="minicart-list">
                    <li class="minicart-product">
                        <a class="product-item_remove" href="#"><i class="pe-7s-close" data-tippy="Remove" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder" tabindex="0"></i></a>
